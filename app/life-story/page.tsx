...
const chapters = [
  ...
  },
  {
    ...
    location: "",
    accent: "#3D405B",
    body: "I am 26, living in Boston, and working as a freelance AI product and partnerships consultant. Most of that work right now is with iBlueprint.ai, an AI chatbot and workflow-agent platform, where I help with product QA, sales and investor outreach, and partnerships with government and social-impact organizations. Before this, I spent nearly two years at Project Evident on the OutcomesAI team, helping nonprofits figure out how to use AI in ways that actually serve the people they work with.\n\nI also lead Art Reach Cambodia, a Khmer-led documentary storytelling project based in Battambang that I started to document Khmer artists, athletes, and journalists whose stories don\u2019t get told enough. We work in partnership with SafeSpaceBTB and a team of Khmer youth and collaborators, and we are finishing our first series while raising funds for the second. It started as a personal question and turned into something much bigger than me.\n\nThe tension I felt at 23 is still there, honestly. I am still figuring out how to be all the things I want to be. I am less afraid of that now. I know what I care about, I know what lights me up. Things are starting to come together, and I am paying attention.",
  },
];
